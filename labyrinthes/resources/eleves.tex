...
\subsection{Quelques exemples}
  ...
  \subsection{Représentation du problème}
      On choisit de représenter les cases d'un labyrinthe par les cases d'un tableau à double entrée dans lequel 
  ...
  \subsection{Objectifs}
    \begin{enumerate}[$\bullet$]
     \item \'Etudier/\'Etablir un algorithme (en particulier l'algorithme de Prim) de génération d'un labyrinthe parfait.
	   Visualiser les étapes de construction à l'écran.
     \item \'Etudier / \'Etablir un algorithme pour sortir du labyrinthe.\\
	   Visualiser les étapes de résolution à l'écran.

     \item D'autres applications de l'algorithme de Prim. (Optionnel)
    \end{enumerate}
  ...
  \subsection{Modalités}
    ...
    \begin{enumerate}[$\bullet$]
     \item Séance 1 : se familiariser avec l'environnement de travail. \\
     ...
     \item Séance 2 : programmer quelques fonctions. \\
     ...
     \item Séance 3 : l'algorithme de Prim et mise en \oe uvre (première version).
     \item Séance 4 : l'algorithme de Prim (version améliorée). \\
